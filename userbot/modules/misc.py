...
async def reedme(e):
    await e.edit(
        ...
        "\n[One4uBot's README.md file](https://github.com/Jprimero15/One4uBot/blob/sql-extended/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "[Click here](https://github.com/Jprimero15/One4uBot) to open One4uBot's GitHub page."
    )
